...
mixin _$ArtistState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(ArtitstModel collections) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(ArtitstModel collections)? loaded,
...
abstract class _$$ArtistStateLoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({ArtitstModel collections});

  $ArtitstModelCopyWith<$Res> get collections;
}
...
class __$$ArtistStateLoadedImplCopyWithImpl<$Res>
  ...
  @pragma('vm:prefer-inline')
  $ArtitstModelCopyWith<$Res> get collections {
    return $ArtitstModelCopyWith<$Res>(_value.collections, (value) {
...
class _$ArtistStateLoadedImpl implements _ArtistStateLoaded {
  ...
  @override
  final ArtitstModel collections;
...
abstract class _ArtistStateLoaded implements ArtistState {
  const factory _ArtistStateLoaded(final ArtitstModel collections) =
      _$ArtistStateLoadedImpl;

  ArtitstModel get collections;
  @JsonKey(ignore: true)
  _$$ArtistStateLoadedImplCopyWith<_$ArtistStateLoadedImpl> get copyWith =>
      throw _privateConstructorUsedError;
}
